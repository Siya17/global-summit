...
export type Regulation = { id: string; number: number; title: string; text: string; evidenceFor: string; evidenceChallenge: string; evidenceDataPoint: string; evidenceBars?: EvidenceBar[]; sources: Source[] };
